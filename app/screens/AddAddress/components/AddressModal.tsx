...
import { View, Text, TouchableOpacity, MaterialIcons,OutlinedTextField, FeatherIcon } from '../../../components/Themed';
...
export const AddressModal = (props: AddressModalProps) => {
    ...
    return (
        <KeyboardAvoidingView behavior="height" style={styles.container}>
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={() => {navigation.navigate('SearchPlace',{backScreen:'Add',title:'Add a new address',  defaultAddress:Address.address})}} style={styles.cardContainer}>
                <View>
